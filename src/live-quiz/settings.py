"""
Django settings for live-quiz project.
...
SECRET_KEY = 'n=-rj_-21283rgyzay+thu1tlt5@@)-l2ef(o!fq^66)b@e=+v'
...
WSGI_APPLICATION = 'live-quiz.wsgi.application'
...
ASGI_APPLICATION = 'live-quiz.routing.application'
